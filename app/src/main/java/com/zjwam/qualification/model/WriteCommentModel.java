...
public class WriteCommentModel implements IWriteCommentModel {
    @Override
    public void upComment(String url, Object context, Map<String, String> param, final BasicCallback<ResponseBean<EmptyBean>> basicCallback) {
